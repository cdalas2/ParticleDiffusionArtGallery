...
HeadInsidehp=plot(HeadInsidePositions(:,1),HeadInsidePositions(:,2),'.','MarkerSize',15,'MarkerEdgeColor',[0.93,0.69,0.13],...
    'MarkerFaceColor',[0.93,0.69,0.13]);
Chainshp=plot(ChainsPositions(:,1),ChainsPositions(:,2),'.','MarkerSize',15,'MarkerEdgeColor',[0.60,0.20,0.48],...
    'MarkerFaceColor',[0.60,0.20,0.48]);
EmptySpaceInsidehp=plot(EmptySpaceInsidePositions(:,1),EmptySpaceInsidePositions(:,2),'.','MarkerSize',15,'MarkerEdgeColor',[0.84,0.91,0.85],...
